...
/**
 * @brief Pointer on generic function to create a table.
 *
 */
typedef th_generic_table_t (*th_create_func_t)(void);

/**
 * @brief Pointer on generic function to get a value from a table.
 *
 */
typedef th_any_t (*th_get_func_t)(th_generic_table_t, th_any_t, size_t);

/**
 * @brief Pointer on generic function to insert a value into a table.
 *
 */
typedef bool (*th_put_func_t)(th_generic_table_t, th_any_t, size_t, th_any_t);

/**
 * @brief Pointer on generic function to delete a value from a table.
 *
 */
typedef bool (*th_delete_func_t)(th_generic_table_t, th_any_t, size_t);

/**
 * @brief Pointer on generic function to free a table.
 *
 */
